...
import icon from "../../../images/icons/icon_4.svg"
...
const PdfToWord = () => {
    ...
    if (selectedFile) {
      ...
      try {
        ...
        const response = await axios.post(
          "http://127.0.0.1:5000/pdf_to_word",
          formData,
          {
            responseType: "blob",
          }
  ...
  const handleDownload = () => {
    ...
    const downloadFileName = `${fileNameWithoutExtension}.docx`;
   ...
   <>
     ...
     <div className=" container  mx-auto px-4">
       <div
         ...
         style={{ marginTop: "-38rem", maxWidth: "90rem", maxHeight: "100rem" }}
       >
         <h1
             ...
             {selectedFile ? (
               ...
               <div>
                 ...
                 <label
                   ...
                   style={{ maxWidth: "750px", marginTop: "1.2rem", marginBottom:'2rem' }}
                 >
                   Select File
                 </label>
               </div>
