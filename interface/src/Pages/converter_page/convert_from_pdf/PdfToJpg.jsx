...
import icon from "../../../images/icons/icon_11.svg";
...
const PdfToImage = () => {
    ...
    if (selectedFile) {
      ...
      try {
        ...
        const response = await axios.post(
          "http://127.0.0.1:5000/convert_pdf_to_images",
          formData,
          {
            responseType: "blob",
          }
  ...
  const handleDownload = () => {
    ...
    const downloadFileName = `${fileNameWithoutExtension}.zip`;
      ...
      <div className=" container  mx-auto px-4">
        ...
        >
          ...
          <form onSubmit={handleFileUpload}>
              ...
              {selectedFile ? (
                ...
                <div>
                  <p className="mb-2 font-bold">
                    Drag and drop your PDF file to convert
                  </p>
            ...
            >
              {loading ? "Loading..." : "Convert to Images"}
            </button>
          </form>
          {selectedFile && downloadUrl && (
            <div className="text-center mt-4">
              ...
              {/* Add the print button here if needed */}
            </div>
          )}
        </div>
      </div>
