      ...
      <div className="block__container">
        <div className="block__header">
          ...
          <div className="subtitle text-center">
            ConverterArea is your number 1 web app for editing PDF with ease. Enjoy all the tools you need to work efficiently with your digital documents while keeping your data safe and secure.
          </div>               
        </div>
